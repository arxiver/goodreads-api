...
curl -X GET -G "http://localhost/api/showReviewForBookForUser" \
    -H "Content-Type: application/json" \
    -d '{"userId":"hcwf7bkxmnDRTwCf","bookId":"4mIBsfqS5BxkVGKn"}'
...
let body = {
    "userId": "hcwf7bkxmnDRTwCf",
    "bookId": "4mIBsfqS5BxkVGKn"
}
...
curl -X GET -G "http://localhost/api/shelf" \
    -H "Content-Type: application/json" \
    -d '{"user_id":8,"shelf_name":"jO7bGuqTGm6JCeAg"}'
...
curl -X POST "http://localhost/api/login" \
    -H "Content-Type: application/json" \
    -d '{"email":"1POuk1pos1YOvHyo","password":"TdUkZRLBRaA6tHnt"}'
...
let body = {
    "email": "1POuk1pos1YOvHyo",
    "password": "TdUkZRLBRaA6tHnt"
}
