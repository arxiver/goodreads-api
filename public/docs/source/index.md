...
```json
{
    ...
    "file": "F:\\proj\\goodreads-api\\vendor\\laravel\\framework\\src\\Illuminate\\Foundation\\Exceptions\\Handler.php",
    "line": 200,
    "trace": [
        {
            "file": "F:\\proj\\goodreads-api\\vendor\\laravel\\framework\\src\\Illuminate\\Foundation\\Exceptions\\Handler.php",
        ...
        {
            "file": "F:\\proj\\goodreads-api\\app\\Exceptions\\Handler.php",
            "line": 49,
            "function": "render",
            "class": "Illuminate\\Foundation\\Exceptions\\Handler",
            "type": "->"
        ...
        {
            "file": "F:\\proj\\goodreads-api\\vendor\\nunomaduro\\collision\\src\\Adapters\\Laravel\\ExceptionHandler.php",
            "line": 68,
            "function": "render",
        ...
        {
            "file": "F:\\proj\\goodreads-api\\app\\Http\\Middleware\\Authorized.php",
            "line": 24,
...
curl -X GET -G "http://localhost/api/shelf/shelfid" \
    -H "Content-Type: application/json" \
    -d '{"user_id":6,"page":19,"books_per_page":10}'
...
curl -X GET -G "http://localhost/api/shelf" \
    -H "Content-Type: application/json" \
    -d '{"user_id":3,"shelf_name":"EDSqjMyS8pwgDe1E"}'
...
curl -X POST "http://localhost/api/signUp" \
    -H "Content-Type: application/json" \
    -d '{"email":"qOnxYXjnXYPfZ8Mq","password":"xBgwnjEZOfVPvzJ3","password_confirmation":"sV2k8MXExbssCGu6","name":"OPGkAmdY2cak920v","gender":"RG2sCiWrrNYOybCL","birthday":"AMLTB0DXdkqvkpKd","country":"MmpI1GTURuWstXkG","city":"l9H0kdGmdP7HSDMZ"}'
...
let body = {
    "email": "qOnxYXjnXYPfZ8Mq",
    "password": "xBgwnjEZOfVPvzJ3",
    "password_confirmation": "sV2k8MXExbssCGu6",
    "name": "OPGkAmdY2cak920v",
    "gender": "RG2sCiWrrNYOybCL",
    "birthday": "AMLTB0DXdkqvkpKd",
    "country": "MmpI1GTURuWstXkG",
    "city": "l9H0kdGmdP7HSDMZ"
}
...
curl -X GET -G "http://localhost/api/whoCanSeeMyBirthday" \
    -H "Content-Type: application/json" \
    -d '{"seeMyBirthday":"zwZmUSttJeUoWfrS"}'
...
let body = {
    "seeMyBirthday": "zwZmUSttJeUoWfrS"
}
...
curl -X GET -G "http://localhost/api/whoCanSeeMyCountry" \
    -H "Content-Type: application/json" \
    -d '{"seeMyCountry":"bH9vm5xan00g6qva"}'
...
curl -X POST "http://localhost/api/makeComment" \
    -H "Content-Type: application/json" \
    -d '{"id":16,"type":15,"body":"uPPjQ9SsLDsQcm2D"}'
...
curl -X PUT "http://localhost/api/reviwes/edit" \
    -H "Content-Type: application/json" \
    -d '{"reviewId":5,"body":"mSc246PVgbq3eOK9","rating":11}'
...
curl -X POST "http://localhost/api/reviwes/create" \
    -H "Content-Type: application/json" \
    -d '{"bookId":15,"shelf":12,"body":"4VksZC7IlroeGN1t","rating":11}'
...
curl -X GET -G "http://localhost/api/Books/book_Authorname" \
    -H "Content-Type: application/json" \
    -d '{"Author_name":"cNbvpTHYJOQJp4wM"}'
...
curl -X GET -G "http://localhost/api/reviwes/books" \
    -H "Content-Type: application/json" \
    -d '{"title":"5AQpg0fx9TMjoq9M","author":"4M4eFaQ6p8zstuxy","rating":13}'
...
let body = {
    "title": "5AQpg0fx9TMjoq9M",
    "author": "4M4eFaQ6p8zstuxy",
    "rating": 13
}
...
```json
{
    ...
    "file": "F:\\proj\\goodreads-api\\app\\Http\\Controllers\\ReviewController.php",
    "line": 452,
    "trace": [
        {
            "file": "F:\\proj\\goodreads-api\\app\\Http\\Controllers\\ReviewController.php",
...
curl -X GET -G "http://localhost/api/showReviewForBookForUser" \
    -H "Content-Type: application/json" \
    -d '{"userId":"UbW6E38oaFrd9HNI","bookId":"EbdotsuEYwTUU33n"}'
...
let body = {
    "userId": "UbW6E38oaFrd9HNI",
    "bookId": "EbdotsuEYwTUU33n"
}
...
curl -X POST "http://localhost/api/logIn" \
    -H "Content-Type: application/json" \
    -d '{"email":"Vm3eIJG3xugCkPYG","password":"23Dom6d1iwgDIHTG"}'
...
let body = {
    "email": "Vm3eIJG3xugCkPYG",
    "password": "23Dom6d1iwgDIHTG"
}
