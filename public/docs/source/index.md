...
curl -X GET -G "http://localhost/api/shelf/shelfid" \
    -H "Content-Type: application/json" \
    -d '{"user_id":9,"page":1,"books_per_page":18}'
...
curl -X POST "http://localhost/api/signup" \
    -H "Content-Type: application/json" \
    -d '{"email":"MAzYiLEzcTsACVlv","password":"ZO8k43wHvPQ6RZb8","password_confirmation":"iWUYqbjt5GRjR6Xg","name":"fBU8hGq15Jy36uU7","gender":"vpySkgHVdPQfp1kT","birthday":"6VwrXrDZeDmeKymm","country":"k81XZqftJxMtjCjK","city":"cyHEzWdXTAm319Bs"}'
...
let body = {
    "email": "MAzYiLEzcTsACVlv",
    "password": "ZO8k43wHvPQ6RZb8",
    "password_confirmation": "iWUYqbjt5GRjR6Xg",
    "name": "fBU8hGq15Jy36uU7",
    "gender": "vpySkgHVdPQfp1kT",
    "birthday": "6VwrXrDZeDmeKymm",
    "country": "k81XZqftJxMtjCjK",
    "city": "cyHEzWdXTAm319Bs"
}
...
curl -X POST "http://localhost/api/changepassword" \
    -H "Content-Type: application/json" \
    -d '{"password":"IYy0gINmANkMkxG4","newPassword":"r4MG0wcYgqy4jK5K","newPassword_confirmation":"lK9bd61Z3wWVEAkJ"}'
...
let body = {
    "password": "IYy0gINmANkMkxG4",
    "newPassword": "r4MG0wcYgqy4jK5K",
    "newPassword_confirmation": "lK9bd61Z3wWVEAkJ"
}
...
curl -X GET -G "http://localhost/api/changebirthday" \
    -H "Content-Type: application/json" \
    -d '{"newBirthday":"LETAd625nHfZBGpn"}'
...
curl -X GET -G "http://localhost/api/whocanseemybirthday" \
    -H "Content-Type: application/json" \
    -d '{"seeMyBirthday":"tATfGSYu971tpO7F"}'
...
let body = {
    "seeMyBirthday": "tATfGSYu971tpO7F"
}
...
curl -X GET -G "http://localhost/api/whocanseemycountry" \
    -H "Content-Type: application/json" \
    -d '{"seeMyCountry":"GEUlkgy4bOEU21fw"}'
...
curl -X POST "http://localhost/api/makeComment" \
    -H "Content-Type: application/json" \
    -d '{"id":6,"type":12,"body":"BHjvH6UDCoF5ycsa"}'
...
curl -X GET -G "http://localhost/api/Books/book_Authorname" \
    -H "Content-Type: application/json" \
    -d '{"Author_name":"8abQKvTiI3wrU2Rd"}'
...
curl -X PUT "http://localhost/api/reviwes/edit" \
    -H "Content-Type: application/json" \
    -d '{"reviewId":4,"body":"YJX9mW7Axgcbgb9o","rating":1}'
...
curl -X POST "http://localhost/api/reviwes/create" \
    -H "Content-Type: application/json" \
    -d '{"bookId":5,"shelf":1,"body":"mgNkCsJHdowaerPz","rating":18}'
...
curl -X GET -G "http://localhost/api/reviwes/books" \
    -H "Content-Type: application/json" \
    -d '{"title":"On9Rgh4KVeNpWma3","author":"VhRpE8C3ZYpau5Ex","rating":10}'
...
let body = {
    "title": "On9Rgh4KVeNpWma3",
    "author": "VhRpE8C3ZYpau5Ex",
    "rating": 10
}
...
curl -X GET -G "http://localhost/api/showReviewForBookForUser" \
    -H "Content-Type: application/json" \
    -d '{"userId":"dUJ1d64t94y4e6c6","bookId":"W3Z60GXKBrykK6p8"}'
...
let body = {
    "userId": "dUJ1d64t94y4e6c6",
    "bookId": "W3Z60GXKBrykK6p8"
}
...
curl -X GET -G "http://localhost/api/shelf" \
    -H "Content-Type: application/json" \
    -d '{"user_id":9,"shelf_name":"H10MWDNQ501wagtY"}'
...
curl -X GET -G "http://localhost/api/shelf/getbook" \
    -H "Content-Type: application/json" \
    -d '{"user_id":11,"shelf_name":"bzV70W4L2kR6QjzE"}'
...
curl -X POST "http://localhost/api/login" \
    -H "Content-Type: application/json" \
    -d '{"email":"Wgi5c3jpuCR3TFnh","password":"PdTZcAaQ93ZRNYyV"}'
...
let body = {
    "email": "Wgi5c3jpuCR3TFnh",
    "password": "PdTZcAaQ93ZRNYyV"
}
